...
<main id="main">
    ...
    <section id="covid" class="covid">
      <div class="container" data-aos="fade-up">
		...
		<h2>IMS (Infeksi Menular Seksual)</h2>
          <p>Data berikut merupakan akumulasi data pasien IMS (Infeksi Menular Seksual) yang masuk di sistem </p>
  ...
  <script type="text/javascript">
		...
		getLayer = L.geoJson(data, {
			style: function(feature, layer) {
				...
				$.getJSON("http://localhost:81/api-spm/api/imsKel?id_kel="+id_kel, function(data){
					...
					info_bidang+="<hr> "
					info_bidang+="<h6>Jumlah Pasien di seluruh Kasus : " + data.IMS_all + "</h6>"
					info_bidang+="<h6>Jumlah Pasien Aktif : " + data.IMS_aktif + "</h6>"
					info_bidang+="<h6>Jumlah Pasien Sembuh : " + data.IMS_sembuh + "</h6>"
					info_bidang+="<h6>Jumlah Pasien Meninggal : " + data.IMS_die + "</h6>"
