    ...
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(<?= base_url()?>template/front/assets/img/diare-1.gif)">
          <div class="container">
            <h2> <span>Peta Sebaran Kasus Diare </span></h2>
...
<main id="main">
    ...
    <section id="covid" class="covid">
      <div class="container" data-aos="fade-up">
		...
		<h2>Diare</h2>
          <p>Data berikut merupakan akumulasi data pasien Diare yang masuk di sistem </p>
  ...
  <script type="text/javascript">
		...
		getLayer = L.geoJson(data, {
			style: function(feature, layer) {
				...
				$.getJSON("http://localhost:81/api-spm/api/diareKel?id_kel="+id_kel, function(data){
					...
					info_bidang+="<h6>Jumlah Pasien di seluruh Kasus : " + data.Diare_all + "</h6>"
					info_bidang+="<h6>Jumlah Pasien Aktif : " + data.Diare_aktif + "</h6>"
					info_bidang+="<h6>Jumlah Pasien Sembuh: " + data.Diare_sembuh + "</h6>"
					info_bidang+="<h6>Jumlah Pasien Meninggal : " + data.Diare_die + "</h6>"
					//dalam perawatan
					info_bidang+="<hr size = '1px'> "
