...
<section id="hero">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(<?= base_url()?>template/front/assets/img/dbd-1.gif)">
          <div class="container">
            <h2> <span>Peta Sebaran Kasus DBD </span></h2>
...
<main id="main">
    ...
    <section id="covid" class="covid">
      <div class="container" data-aos="fade-up">
		...
		<h2>DBD</h2>
          <p>Data berikut merupakan akumulasi data pasien DBD yang masuk di sistem </p>
