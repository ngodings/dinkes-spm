    ...
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(<?= base_url()?>template/front/assets/img/tbc-1.gif)">
          <div class="container">
            <h2><span>Data Penyakit TBC di Kota Surakarta</span></h2>
		...
		getLayer = L.geoJson(data, {
			...
			onEachFeature: function(feature, layer){
				...
				$.getJSON("http://localhost:81/api-spm/api/countData?id_kec="+id_kec, function(data){
					...
					info_bidang+="<div style='width:100%;text-align:center;margin-top:10px;'><a href='<?=base_url()?>peta/get_detail_tbc/"+id_kec+"'> Detail </a></div>";
